...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print("\n@@@ Operacao falhou! O numero maximo de saques excedido. @@@")

    elif valor > 0:
        saldo -= valor 
        extrato += f"Saque:\t\tR$ {valor:.2f}\n"
        numero_saques += 1
        print("\n=== Saque realizados com sucesso! ===")
...
def criar_usuario(usuarios):
    ...
    if usuario:
        ...
        return
    nome = input("Ïnforme o nome completo: ")
    data_nascimento = input("Informe a data de nascimento (dd-mm-aaa): ")
    endereco = input("Informe o endereco (logradouto, nro - bairro - cidade/sigla estado): ")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    if usuario:
        print("\n== Conta criada coms sucesso! ==")
        return {"agencia": agencia, "numero_conta": numero_conta, "usuario": usuario}
   
    print("\n@@@ Usuário não encontrado, fluxo de criacao de conta encerrado! @@@")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("Operacao invalida, por favor selecione novamete a operacao desejada")
